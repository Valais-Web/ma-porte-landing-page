        ...
        <div className="hidden lg:block mb-20">
          ...
          loop: true
            ...
            <CarouselContent className="-ml-6">
              {realizations.map((realization, index) => <CarouselItem key={index} className="pl-6 basis-1/3">
        ...
        <div className="lg:hidden mb-20">
          <Carousel className="w-full">
            <CarouselContent className="-ml-4">
              {realizations.map((realization, index) => <CarouselItem key={index} className="pl-4 basis-4/5 sm:basis-1/2 md:basis-1/3">
                  <div className="group cursor-pointer transform-gpu">
