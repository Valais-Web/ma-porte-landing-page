...
export const Benefits = () => {
  ...
  return <section className="py-20 bg-maporte-gray-light">
      <div className="container-maporte">
        <div className="text-center mb-16">
          <h2 className="text-3xl lg:text-4xl font-jost font-semibold text-maporte-black mb-4">Les bénéfices qui comptent pour VOUS
        </h2>
          <p className="text-xl text-maporte-gray-medium font-roboto">Au-delà d'une simple porte, un investissement durable</p>
        </div>
